	...
	var cart = {
		'add': function(id_product, logged, product_name, image, url_product) {
		    if(logged === "True") {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        {
                            addProductNotice('Add ' + product_name + ' to Cart', '<a href="' + url_product + '"><img src="' + image + '" alt=""></a>', '<h3>' + data.message_error + '</h3>', 'success');
                        }
                    }
                });
            }
            ...
            {
                addProductNotice('Add product to Cart', '<img src="' + image + '" alt="">', '<h3>You must <a href="#">login</a>  to save <a href="' + url_product + '">"' + product_name + '"</a> to your <a href="/e_commerce/cart">shopping cart</a>!</h3>', 'success');
            }
		},
		'remove':function(id_product, product_name, image, url_product) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    {
                        addProductNotice('Remove ' + product_name + ' from Cart', '<a href="' + url_product + '"><img src="' + image + '" alt=""></a>', '<h3>' + data.message_error + '</h3>', 'success');
                    }
                }
            });
        }
	    ...
	    'add': function(id_product, logged, product_name, image, url_product) {
		    if(logged === "True") {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.message_error === ""){
                            addProductNotice('Product added to Compare', '<a href="' + url_product + '"><img src="' + image + '" alt=""></a>', '<h3><a href="' + url_product + '">"' + product_name + '"</a> added to <a href="/e_commerce/wish_list">product comparison</a>!</h3>', 'success');
                            $("#number_in_compare").html("<i class='fa fa-refresh'></i>Compare (" + data.number_products_in_compare + ")");
                        }
                        else
                        {
                            addProductNotice('Add ' + product_name + ' to compare', '<a href="' + url_product + '"><img src="' + image + '" alt=""></a>', '<h3>' + data.message_error + '</h3>', 'success');
                        }
                    }
                });
            }
            ...
            {
                addProductNotice('Add product to comare', '<img src="' + image + '" alt="">', '<h3>You must <a href="#">login</a>  to save <a href="' + url_product + '">"' + product_name + '"</a> to your <a href="/e_commerce/wish_list">product comparison</a>!</h3>', 'success');
            }
		}
	};
